...
Pstate NorthElectrode;      //  States machine used to recognize the pressure on the North electrode and manage the digital outputs on the I/O expanders (MCP23017)
Pstate SouthElectrode;      //  States machine used to recognize the pressure on the South electrode and manage the digital outputs on the I/O expanders (MCP23017)
Pstate WestElectrode;       //  States machine used to recognize the pressure on the West electrode and manage the digital outputs on the I/O expanders (MCP23017)
Pstate EastElectrode;       //  States machine used to recognize the pressure on the East electrode and manage the digital outputs on the I/O expanders (MCP23017)
Pstate CentreElectrode;     //  States machine used to recognize the pressure on the Centre electrode and manage the digital outputs on the I/O expanders (MCP23017)
//======================================================================
...
uint8_t  WestTouch[8];        // ¯|
uint8_t  WestCounter;         //  |___ Set of variables used to store gestures sequence. Usefull to recognize between Touch, Tap and Double Tap gesture. West electrode
uint8_t  WestData;            // _|
uint8_t  EastTouch[8];        // ¯|
uint8_t  EastCounter;         //  |___ Set of variables used to store gestures sequence. Usefull to recognize between Touch, Tap and Double Tap gesture. East electrode
uint8_t  EastData;            // _|
uint8_t  CentreTouch[8];      // ¯|
uint8_t  CentreCounter;       //  |___ Set of variables used to store gestures sequence. Usefull to recognize between Touch, Tap and Double Tap gesture. Centre electrode
uint8_t  CentreData;          // _|
...
#define GESTURE_DOUBLE_TAP_EAST   10   //  |___ The "double tap gesture" is composed by a sequence of gestures. So the sum of gesture codes that have been read returns the value indicated
#define GESTURE_DOUBLE_TAP_CENTRE 10   // _|
#define GESTURE_TAP_WEST          3    // ¯|
#define GESTURE_TAP_EAST          3    //  |___ The "tap gesture" is composed by a sequence of gestures. So the sum of gesture codes that have been read returns the value indicated
#define GESTURE_TAP_CENTRE        3    // _|
#define GESTURE_TOUCH_WEST        1    // ¯| 
#define GESTURE_TOUCH_EAST        1    //  |___ The "Touch Gesture"
#define GESTURE_TOUCH_CENTRE      1    // _|
//============================================
...
//#define GESTURE_DOUBLE_TAP_EAST   7    //  |___ The "double tap gesture" is composed by a sequence of gestures. So the sum of gesture codes that have been read returns the value indicated
//#define GESTURE_DOUBLE_TAP_CENTRE 7    // _|
//#define GESTURE_TAP_WEST          2    // ¯|  
//#define GESTURE_TAP_EAST          2    //  |___ The "tap gesture" is composed by a sequence of gestures. So the sum of gesture codes that have been read returns the value indicated
//#define GESTURE_TAP_CENTRE        2    // _|
//#define GESTURE_TOUCH_WEST        1    // ¯| 
//#define GESTURE_TOUCH_EAST        1    //  |___ The "Touch Gesture"
//#define GESTURE_TOUCH_CENTRE      1    // _|
//============================================
...
//#define GESTURE_DOUBLE_TAP_EAST   5    //  |___ The "double tap gesture" is composed by a sequence of gestures. So the sum of gesture codes that have been read returns the value indicated
//#define GESTURE_DOUBLE_TAP_CENTRE 5    // _|
//#define GESTURE_TAP_WEST          3    // ¯|  
//#define GESTURE_TAP_EAST          3    //  |___ The "tap gesture" is composed by a sequence of gestures. So the sum of gesture codes that have been read returns the value indicated
//#define GESTURE_TAP_CENTRE        3    // _|
//#define GESTURE_TOUCH_WEST        1    // ¯| 
...
//======================================================================
const char KeyboardEnabled[]  PROGMEM = "PC interactive mode enabled";
const char KeyboardDisabled[] PROGMEM = "PC interactive mode disabled";

const char GestureTapCentre[]        PROGMEM = "Tap Centre              -> Opens program on the PC  -> CTRL + SHIFT + F1";
const char GestureDoubleTapCentre[]  PROGMEM = "DoubleTap Centre        -> Closes program on the PC -> ESC";

const char GestureTaWest[]           PROGMEM = "Tap West                -> Opens image              -> ENTER";
const char GestureTabEast[]          PROGMEM = "Tap East                -> Closes image             -> ESC";

const char GestureWestEast[]         PROGMEM = "Flick West To East      -> Opens next image         -> RIGHT ARROW";
const char GestureEastWest[]         PROGMEM = "Flick East To West      -> Opens last image         -> LEFT ARROW";
const char GestureEdgeWestEast[]     PROGMEM = "Flick Edge West To East -> Zooms + image            -> ZOOM +";
const char GestureEdgeEastWest[]     PROGMEM = "Flick Edge East To West -> Zooms - image            -> ZOOM -";

const char GestureNorthSouth[]       PROGMEM = "Flick North to South    -> Moves image zoomed       -> DOWN ARROW";
const char GestureSouthNorth[]       PROGMEM = "Flick South to North    -> Moves image zoomed       -> UP ARROW";
...
//======================================================================
void setup() {
  mgc3130.SetSerial((uint16_t)(57600), SERIAL_8N1);
  ...
  WestElectrode    = WestElectrode_Idle;      //  Initializes states machine used to recognize the pressure on the West electrode
  EastElectrode    = EastElectrode_Idle;      //  Initializes states machine used to recognize the pressure on the East electrode
  CentreElectrode  = CentreElectrode_Idle;    //  Initializes states machine used to recognize the pressure on the Centre electrode
...
void loop() {
  ...
  if (mgc3130.GetTsLineStatus(Ts_MGC3130) == TRUE) {

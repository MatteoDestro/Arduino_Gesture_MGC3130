...
uint8_t  NorthCounter;        //  |___ Set of variables used to store gestures sequence. Usefull to recognize between Touch, Tap and Double Tapgesture. North electrode
uint8_t  NorthData;           // _|
uint8_t  SouthTouch[8];       // ¯|
uint8_t  SouthCounter;        //  |___ Set of variables used to store gestures sequence. Usefull to recognize between Touch, Tap and Double Tap gesture. South electrode
uint8_t  SouthData;           // _|
uint8_t  WestTouch[8];        // ¯|
...
#define GESTURE_DOUBLE_TAP_SOUTH  10   //  |___ The "double tap gesture" is composed by a sequence of gestures. So the sum of gesture codes that have been read returns the value indicated
...
#define GESTURE_TAP_SOUTH         3    //  |___ The "tap gesture" is composed by a sequence of gestures. So the sum of gesture codes that have been read returns the value indicated
#define GESTURE_TAP_WEST          3    //  | 
#define GESTURE_TAP_EAST          3    //  |
#define GESTURE_TAP_CENTRE        3    // ¯ 
#define GESTURE_TOUCH_NORTH       1    // ¯|
#define GESTURE_TOUCH_SOUTH       1    //  |___ The "Touch Gesture"
...
//#define GESTURE_DOUBLE_TAP_SOUTH  7   //  |___ The "double tap gesture" is composed by a sequence of gestures. So the sum of gesture codes that have been read returns the value indicated
...
//#define GESTURE_TAP_SOUTH         2   //  |___ The "tap gesture" is composed by a sequence of gestures. So the sum of gesture codes that have been read returns the value indicated
//#define GESTURE_TAP_WEST          2   //  |
//#define GESTURE_TAP_EAST          2   //  |
//#define GESTURE_TAP_CENTRE        2   // ¯
//#define GESTURE_TOUCH_NORTH       1   // ¯|
//#define GESTURE_TOUCH_SOUTH       1   //  |___ The "Touch Gesture" is filtered
//#define GESTURE_TOUCH_WEST        1   //  |
//#define GESTURE_TOUCH_EAST        1   //  |
//#define GESTURE_TOUCH_CENTRE      1   // ¯
//============================================
...
//#define GESTURE_DOUBLE_TAP_SOUTH   5   //  |___ The "double tap gesture" is composed by a sequence of gestures. So the sum of gesture codes that have been read returns the value indicated
//#define GESTURE_DOUBLE_TAP_WEST    5   //  |
//#define GESTURE_DOUBLE_TAP_EAST    5   //  |
//#define GESTURE_DOUBLE_TAP_CENTRE  5   // ¯
//#define GESTURE_TAP_NORTH          3   // ¯|
//#define GESTURE_TAP_SOUTH          3   //  |___ The "Touch Gesture" is filtered
//#define GESTURE_TAP_WEST           3   //  |
//#define GESTURE_TAP_EAST           3   //  |
//#define GESTURE_TAP_CENTRE         3   // ¯
//#define GESTURE_TOUCH_NORTH        1   // ¯|
